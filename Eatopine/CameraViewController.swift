...
public class CameraPassthroughView: UIView {
...
class CameraViewController: UIViewController{
                ...
                stillImageOutput.captureStillImageAsynchronouslyFromConnection(connection, completionHandler: { (imageDataSampleBuffer, error: NSError?) -> Void in
                    ...
                    if error == nil {
                        ...
                        if let takenImage = UIImage(data: imageData) {
                            ...
                            let filterVC = self.storyboard?.instantiateViewControllerWithIdentifier("FilterViewController") as! FilterViewController
                            
                            self.captureSession.stopRunning()
                            self.motionManager.stopAccelerometerUpdates()
                            
                            filterVC.capturedImage = cropTakenImage
    ...
    @IBAction func onPhotoLibraryBtnClick(sender: AnyObject) {
        ...
        let imagePickerController = storyboard?.instantiateViewControllerWithIdentifier("ImagePickerController") as! ImagePickerController
        self.tabBarController?.hidesBottomBarWhenPushed
